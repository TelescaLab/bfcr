...
get_posterior_means_cpp_correct <- function(mcmc_results, xi, alpha, mode) {
    .Call(`_BayesianConditionalFPCA_get_posterior_means_cpp_correct`, mcmc_results, xi, alpha, mode)
}
...
get_posterior_eigen_cpp_correct <- function(mcmc_results, eigenvals, zi, alpha, mode) {
